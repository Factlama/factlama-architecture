...
### ADR-002 - Judge provider abstraction
...
### ADR-004 - Evidence abstraction
Accepted. FactLama verifies against evidence; it is not itself a generic RAG system.

### ADR-005 - SLM is optional and benchmark-gated
...
### ADR-007 - Interaction Store deferred
