...
Detailed build checklists: [Reliability](https://github.com/Factlama/factlama-reliability/blob/main/docs/LOW_LEVEL_IMPLEMENTATION.md) and [Observability](https://github.com/Factlama/factlama-observability/blob/main/docs/LOW_LEVEL_IMPLEMENTATION.md). Use the table to choose what to inspect; use the linked specs to verify behavior. Deferred features (own SLM, vector retrieval, interaction replay, enterprise SSO/Kubernetes) stay on the roadmap and are not part of this MVP acceptance path.
