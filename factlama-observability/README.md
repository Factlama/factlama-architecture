...
This is the centralized component specification for the separate `factlama-observability` code repository. [docs/implementation.md](docs/implementation.md) owns the OBS task ledger. The short README in the code repo points here.
